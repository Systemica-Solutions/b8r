...
function My_propertyPV(){
    ...
    return(
        ...
        <button className="CommonnButton" style={{color:"black",  fontWeight: "1000" , textAlign: "left", fontStyle: "normal", width: "55%", marginRight:"20px",height:"20px",fontSize:"12px" }}>Pending Verification</button>
        <button className="CommonnButtonNew" style={{  fontWeight: "1000" , textAlign: "left", fontStyle: "normal", width: "55%", height:"20px",color:" #D2D7D6" }}>Yet To Share</button>
        </div>
        <div class="buttonBackNext" style={{marginTop:"10px"}}>
        <button className="CommonnButtonNew" style={{  fontWeight: "1000" , textAlign: "left", fontStyle: "normal",height:"10px", width: "55%",marginRight:"25px",color:" #D2D7D6" }}>Shortlisted</button>
        <button className="CommonnButtonNew" style={{  fontWeight: "1000" , textAlign: "left", fontStyle: "normal", height:"12px",width: "55%" ,color:" #D2D7D6"}}>Shared, No Action</button>
        </div>
        {/* -------------------------------button---------------------------------------------- */}
         ...
         <div style={{textAlign:"left",marginTop:"40px"}}>
            <text>
                Hey Yash,<br/>Properties shown here are not verified. Correct wherever necessary to get them ready to share
            </text>
         </div>
         {/* --------------------------------------first tab-------------------------------------------- */}
