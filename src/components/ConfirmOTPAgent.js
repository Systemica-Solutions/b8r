...
style={{ 
      ...
      <div className="login-page">
        ...
        >
          ...
          <h2 style={{color:"#52796F"}}>Confirm OTP</h2>
          ...
          <div style={{marginTop:"100px"}}>
           ...
           <div style={{marginTop:"50px"}}>
            ...
            {/* Submit */}
            <button className="CommonnButton" style={{  fontWeight: "1000" , textAlign: "left", fontStyle: "normal", width: "35%" }}>Submit <img className="vectorSignUp" src={vector} style={{marginTop:"-22px"}} alt="fireSpot"/></button>
            <Footer/>
          </form>
