...
import sharedImg from "./sharedImg.png"
...
function My_PropertySNA(){
    ...
    return(
        ...
        <button className="CommonnButton" style={{  fontWeight: "bold" , textAlign: "left", fontStyle: "normal", height:"12px",width: "55%" ,color:" #D2D7D6"}}>Shared, No Action</button>
        </div>
        {/* -------------------------------button---------------------------------------------- */}
         ...
         <div style={{textAlign:"left",marginTop:"40px"}}>
            <text>
                Hey Yash,<br/>Properties here are active & shared
            </text>
         </div>
         {/* --------------------------------------first tab-------------------------------------------- */}
            ...
            <div style={{height:"78px",width:"302px",background:"#FFFFFF",border:"1px solid #DAF0EE",borderRadius:"15px",boxShadow:"0px 4px 4px rgba(0, 0, 0, 0.25)", display:"flex"}}>
                    ...
                    <div style={{marginTop:"10px"}}>
                            ...
                            <div style={{width:"150px",height:"25px",background:"#FFFFF",borderRadius:"10px",marginTop:"20px",marginLeft:"10px"}}>
                                    <text style={{fontSize:"12px",color:"#00000",marginLeft:"-20px",fontFamily:"Inter",fontStyle:"normal",fontWeight:"bold"}}><img src={sharedImg}/>2 Tenants</text>
                            </div>
